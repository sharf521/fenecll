...
class StoreModel extends BaseModel
{
    ...
    {
        $data = array();
        $sql = "SELECT region_id, region_name, count(*) as count FROM {$this->table} WHERE region_id > 0 GROUP BY region_id ORDER BY count DESC ";
...
$credit_store=$this->store_mod->getrow("select store_jifen from ".DB_PREFIX."store where store_id='$store_id'");
