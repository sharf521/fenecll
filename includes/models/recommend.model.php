...
class RecommendModel extends BaseModel
{
	...
	$cityrow=$this->_city_mod->get_cityrow();
        ...
        if ($recom_id == REC_NEW)
        {
            ...
            $sql = "SELECT g.goods_id, g.goods_name, g.default_image, gs.price, gs.stock,gs.jifen_price,gs.vip_price,g.store_id,g.daishou,g.subhead " .
        ...
        {
            /* 推荐商品 */
            $sql = "SELECT g.goods_id, g.goods_name, g.default_image, gs.price, gs.stock,gs.vip_price,gs.jifen_price,g.daishou,g.subhead,case g.cityhao
                    ...
                    "ORDER BY c desc, g.add_time desc " .  //rg.sort_order
                    "LIMIT {$num}";
