...
".DB_PREFIX."user_priv where user_id = '$userid' and store_id=0");
...
$priv_row=$this->_admin_mod->getrow("select * from ".DB_PREFIX."user_priv where user_id = '$user_id' and store_id=0");
$privs=$priv_row['privs'];
...
$privs=$priv_row['privs'];
$cityid=$priv_row['city'];
$br=$this->_admin_mod->getrow("select city from ".DB_PREFIX."brand where brand_id = '$brand_id'");
	if($privs=="all")
	 {
	 $city_row=$this->city_mod->getAll("select * from ".DB_PREFIX."city");
	 }
