...
$userid=$this->visitor->get('user_id');
   ...
   function shenhe()
	...
	$user_row=$this->member_mod->getrow("select user_name,city from ".DB_PREFIX."member where user_id='$store_id'");	
...
$gbuy_row=$this->_groupbuy_mod->getrow("select * from ".DB_PREFIX."groupbuy where group_id='$id'");	
    $goods_id=$gbuy_row['goods_id'];
	$min_quantity=$gbuy_row['min_quantity'];
	$money_row=$this->money_mod->getrow("select money,money_dj,duihuanjifen,dongjiejifen from ".DB_PREFIX."my_money where user_id='$store_id'");	
