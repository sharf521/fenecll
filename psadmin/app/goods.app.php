...
$row_member=$this->member_mod->getrow("select * from ".DB_PREFIX."member where user_name = '$user'");
   ...
   function ajax_col()
   {
       ...
       $data   = array();
$result=$this->message_mod->getrow("select * from ".DB_PREFIX."goods where goods_id='$id'");
$goodname=$result['goods_name'];
$userid=$result['store_id'];
$result1=$this->message_mod->getrow("select * from ".DB_PREFIX."member where user_id='$userid'");
