...
class FrontendApp extends ECBaseApp
{
    ...
    function display($tpl)
    {
        ...
        $this->assign('hot_keywords', $this->_get_hot_keywords());  // 自定义导航
        ...
        $this->assign('ur', $ur);
        $this->assign('yonghuzhongxin', Lang::get('member_center') . ' - ');
    ...
    function login()
    {
        ...
        if (!IS_POST) {
            ...
            $this->assign('page_title', Lang::get('user_login') . ' - ');
...
//            );
            ...
            $menu['im_seller']['submenu']['gonghuo'] = array(
                ...
                'url' => 'index.php?app=my_theme&act=gonghuo',
                'name' => 'gonghuo',
                'icon' => 'ico20',
            );
            $menu['im_seller']['submenu']['mycaigou'] = array(
                'text' => Lang::get('mycaigou'),
                'url' => 'index.php?app=my_theme&act=my_caigou',
                'name' => 'mycaigou',
                'icon' => 'ico6',
            );
