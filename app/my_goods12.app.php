        ...
        switch ($goods['spec_qty'])
        {
            case 0: // 没有规格
                $specs[intval($_POST['spec_id'])] = array(
					...
					'jifen_price' => floatval($_POST['jifen_price']),
					'vip_price' => floatval($_POST['vip_price']),
                    ...
                    if ($spec_1)
                    {
                        if (($spec_id = intval($_POST['spec_id'][$key]))) // 已有规格ID的
                        {
                            $specs[$key] = array(
								...
								'jifen_price'  => floatval($_POST['jifen_price'][$key]),
								'vip_price'  => floatval($_POST['vip_price'][$key]),
