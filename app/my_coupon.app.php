...
class My_couponApp extends MemberbaseApp 
{
	...
	$this->message_mod =& m('message');
	   ...
	   $mcity=$member_row['city'];
	   	//echo $mcity;
	   $my_money_row=$this->my_money_mod->getrow("select * from ".DB_PREFIX."my_money where user_id='$user_id'");
	...
	$this->canshu_mod=& m('canshu');
	$jinbi_row=$this->canshu_mod->getrow("select yu_jinbi,zong_money,zong_jifen from ".DB_PREFIX."canshu");
