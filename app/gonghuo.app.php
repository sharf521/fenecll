...
/* 商品管理控制器 */
class GonghuoApp extends  MallbaseApp
{
    var $_goods_mod;
    var $_spec_mod;
    var $_image_mod;
   ...
   function ajax_col()
   {
    ...
    function _addible()
    {
        ...
        if (empty($payments))
        {
            $this->show_messages('please_install_payment', 'go_payment', 'index.php?app=my_payment');
                  return false;
        }
        ...
        if (empty($shippings))
        {
                  $this->show_messages('please_install_shipping', 'go_shipping', 'index.php?app=my_shipping');
                  return false;
        }
