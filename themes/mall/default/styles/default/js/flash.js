...
__ads__height="300";
__ads__alt="";
__ads__href="http://www.imm0371.com/";
...
document.write('<div id="crazy_ad_closer" style="visibility:hidden;" onclick="javascript:ads_crazy_ad_obj.swap_show(true);" ><img src="images/closer.gif" border=0></div>');
document.write('</div>');
document.write('</div>');

//Âäµã
__float_html="<div id=crazy_ad_float style='visibility:hidden;position:absolute;left:0px;top:0px;'>";
float_close_html="<div style='width:76px;padding:2px;height:15px;'><div style='float:left;'><img src='images/replay_little.gif' border=0 onclick='ads_crazy_ad_obj.swap_show(true);' style='cursor:pointer' /></div><div style='float:right'><img src='images/close_little.gif' border=0 onclick='ads_crazy_ad_obj.swap_show(false);' style='cursor:pointer' /></div></div></div>";
...
document.write("<a href='"+__ads__href+"' target='_blank' style='padding:0;margin:0;position:absolute;left:0px;'><img src='images/blank.gif' width=80 height=80 border=0  /></a>");
