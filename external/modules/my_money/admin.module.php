...
//查看充值
    ...
    function tixianfeilv_xiugai()
    {
        ...
        $tixianfeimin=trim($_POST['tixianfeimin']);
        $tixianfeimax=trim($_POST['tixianfeimax']);
        ...
        if($_POST)
        {
            $edit_canshu=array(
                ...
                'ks_fei'=>$ks_fei,
                'tixianfeimin'=>$tixianfeimin,
                'tixianfeimax'=>$tixianfeimax,
            );
